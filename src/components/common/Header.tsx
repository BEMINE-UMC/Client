        ...
        <>
            <CustomBox $width="100%" $height="auto" $padding={isMobile ? "0.5rem" : "1rem"} $backgroundcolor="white" $justifycontent="center" $alignitems="center" $borderradius="0">
                <CustomRow $width="100%" $height="auto" $padding="0" $alignitems="center" $justifycontent="space-around">
                    ...
                    <SearchInput $width={isMobile ? "40%" : isTablet ? "50%" : "50%"} />

                    <CustomRow $width="auto" $height="auto" $gap={isMobile ? "0.45rem" : "0.5rem"}>
                        <CustomButton $width='auto' $height='auto' 
                            $padding={isMobile ? "0.15rem" : "0.5rem"} 
                            ...
                            <CustomFont 
                                $color="black" 
                                $fontweight="bold" 
                                $font={isMobile ? "0.6rem" : isTablet ? "0.7rem" : "0.9rem"}>
                                템플릿
                            </CustomFont>
                        </CustomButton>
